        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SectionHeader(title: 'Số mới phát hành', hasViewAll: true),
              const SizedBox(height: 12),
              _buildFeaturedCard(),
              ...
              SectionHeader(title: 'Bài báo Khoa học', hasViewAll: true, viewAllText: 'Mới nhất'),
              ...
              // 6. Mục: Chủ đề của bạn
              SectionHeader(title: 'Chủ đề của bạn', hasViewAll: true),
              const SizedBox(height: 12),
              ArticleCard(
                category: 'DẠY HỌC',
                title: 'Phương pháp dạy học sinh động trong lớp học online',
                author: 'Phạm Thị Minh',
              ),
              ArticleCard(
                category: 'DẠY HỌC',
                title: 'Ứng dụng công nghệ AI trong hỗ trợ học tập của sinh viên',
                author: 'Đinh Văn Hùng',
              ),
              ArticleCard(
                category: 'QUẢN LÝ',
                title: 'Chiến lược nâng cao hiệu quả quản lý nhân sự trong trường học',
                author: 'Võ Thị Thanh Huyền',
              ),

              const SizedBox(height: 30),

              // --- 7. PHẦN MỚI THÊM: BANNER ĐỐI TÁC ---
              const Padding(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'TẠP CHÍ LÍ LUẬN - KHOA HỌC GIÁO DỤC',
                      style: TextStyle(
